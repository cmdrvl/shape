...
#[test]
fn long_display_flags_with_positionals_and_invalid_delimiter_still_display() {
    let cases = [
        help_case(&["--help", OLD_PATH, NEW_PATH, "--delimiter", "bad"]),
        help_case(&["--help", "--json", OLD_PATH, NEW_PATH, "--delimiter", "bad"]),
        version_case(&["--version", OLD_PATH, NEW_PATH, "--delimiter", "bad"]),
        version_case(&[
            "--version",
            "--json",
            OLD_PATH,
